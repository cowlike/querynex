...
class ServerTest extends GroovyTestCase {
	...
	public void testEquals() {
		def s1 = new Server('hostname':'mojo', 'map':'q3dm17ish', 'maxPlayers':20, 'playerList':playerList, 'ip':'10.0.0.5:24000')
		def s2 = new Server('hostname':'mojo', 'map':'q3dm17ish', 'maxPlayers':20, 'playerList':playerList2, 'ip':'10.0.0.5:24000')
		def s3 = new Server('hostname':'mojo', 'map':'q3dm18ish', 'maxPlayers':20, 'playerList':playerList, 'ip':'10.0.0.5:24000')
		assert s1 == s2
		assert s1 != s3
	}
}
